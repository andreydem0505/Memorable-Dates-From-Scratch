...
public class CelebrationInMemoryRepositoryTest {

    private CelebrationInMemoryRepository repository;

    @BeforeEach
    void setUp() {
        repository = CelebrationInMemoryRepository.getInstance();
    ...
    void testSave_WhenNewCelebration_ThenAssignedIdAndStored() {
        ...
        assertSame(celebration, loaded, "Repository should return the same celebration instance that was saved");
    }
    ...
    void testFindAllByIds_WhenSomeIdsExist_ThenReturnExistingCelebrations() {
        ...
        Set<Celebration> found = repository.findAllByIds(queryIds);
    ...
    void testFindAllByIds_WhenNoneExist_ThenReturnEmptySet() {
        Set<Celebration> found = repository.findAllByIds(Set.of(1000L, 2000L));
